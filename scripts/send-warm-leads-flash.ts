 ...
 * ET. Sent from the MenuLift brand address, not Jack personally.
 */
...
const FROM = `MenuLift <hello@${FROM_DOMAIN}>`;
...
const leads: Lead[] = [
  {
    ...
    hook: "We saw you ran the MenuLift grader on your Stylish 2-Bedroom Condo in Syracuse (Armory Square) last night.",
  ...
  },
  {
    ...
    hook: "We saw you ran the MenuLift grader on Candlelight Cabin (the hot-tub cabin near Miguel's) yesterday.",
...
function buildLink(airbnbUrl: string): string {
  return `https://menulift.app/?promo=FLASH50&paste=${encodeURIComponent(airbnbUrl)}#paste`;
}
...
MenuLift's running a launch flash today: 50% off the full Listing Tune-Up — $39 instead of $79 — for the first 10 hosts. Code FLASH50, expires today at 6pm ET.
...
<p>${l.hook}</p>
<p>${l.body}</p>
<p>MenuLift's running a launch flash today: <strong>50% off the full Listing Tune-Up — $39 instead of $79</strong> — for the first 10 hosts. Code <strong style="font-family:ui-monospace,SFMono-Regular,monospace;background:#ecfdf5;padding:2px 6px;border-radius:4px;">FLASH50</strong>, expires today at 6pm ET.</p>
...
<p style="font-size:13px;color:#64748b;margin-top:32px;">— MenuLift<br/><a href="https://menulift.app" style="color:#475569;">menulift.app</a></p>
</body></html>`;
}
